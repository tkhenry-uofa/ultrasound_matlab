...
% vrs_path = vrs_path + "cyst_herc_div_col";
% vrs_name = "250204_MN32-1_8MHz_ATS539_Cyst_HERCULES-Diverging-TxColumn_Intensity_01";

% vrs_path = vrs_path + "cyst_herc_div_row";
% vrs_name = "250204_MN32-1_8MHz_ATS539_Cyst_HERCULES-Diverging-TxRow_Intensity_00";
...
figure();
imagesc(y_range * 1000, z_range * 1000, y_image);
colormap("gray");
axis('image');
clim([-dynamic_range, 0]); 
colorbar;
title(sprintf("Cuda f#=%.1f", bp.f_number));
