...
data_path   = "vrs_data/readi/250409_MN32-5_flow_6mm_360mlpm_FORCES-TxColumn/";
data_file_name = "250409_MN32-5_flow_6mm_360mlpm_FORCES-TxColumn_06.zst";
params_path = data_path + '250409_MN32-5_flow_6mm_360mlpm_FORCES-TxColumn.bp';

static_data_path   = "vrs_data/readi/250409_MN32-5_flow_6mm_static_FORCES-TxColumn/";
static_data_file_name = "250409_MN32-5_flow_6mm_static_FORCES-TxColumn_04.zst";
static_params_path = static_data_path + '250409_MN32-5_flow_6mm_static_FORCES-TxColumn.bp';
...
for i = 1:readi_group_count
    ...
    forces_image_raw = forces_image_raw + low_res_array{1};
end

static_image = process_volume(static_image_raw,dynamic_range);
...
subtitle('Blood Flow', 'FontSize',14)
axis("image")
clim([-dynamic_range, 0]); 
xlabel("Lateral Distance (mm)");
ylabel("Axial Distance (mm)");
