...
function res = show_xdc_mod (Th, view_type)
...
for i=1:M
  ...
  if view_type == "apo"
    c=data(5,i)*ones(2,2); % Colour aprodization
  else
    c=data(23,i)*ones(2,2); % Colour delay
  end
...
if view_type == "apo"
    colormap(hot) % Colour aprodization
else
    colormap(flip(hot,1))% Colour delay
end
