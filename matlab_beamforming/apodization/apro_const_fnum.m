function aprodizations = apro_no_fnum(f_num, vox_loc,element_locs,tx_config)
    ...
    f_length = sqrt(sum(vox_loc.^2));

    % Aprodized aperture diameter
    diameter = f_length/f_num;
    ...
    if type == "xLine"
        max_dist = diameter + depth*tan(angle);
