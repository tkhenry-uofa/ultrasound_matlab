...
sequence_type = SequenceType.Full_Sample;
...
% [points1, amps2] = point_grid( [0:20:200]/1000, [0]/1000, [10:30:190/1000);
...
% [points, amps] = single_cyst(50000, [-10, 10]/1000,[-5, 60]/1000,[90, 100]/1000, 1/1000);
...
parfor T = 1:tx_config.no_transmits
    ...
    test1 = hilbert(rx_scans);
    test2 = hilbert(rx_scans.').';
    all_scans{T} = test2;
end
...
% %% 
% filepath = "C:\Users\tkhen\OneDrive\Documents\MATLAB\lab\vrs_transfers\vrs_data\field_ii\tubes_1mm.mat";
% overwrite = false;
...
% processed_apro = process_volume(apro_volume,dynamic_range);
...
% apro_slice = squeeze(processed_apro(:,vol_config.y_mid,:))';
figure(1)
% 
% subplot 121
